    ...
    $("#search").click(function (e) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                for (var i = 0; i < 5; i++) {
                    tableHtml += "<tr class=\"table-header\"><th>" + (i + 1) + "</th><th>" + result[i].name + "</th><th>" + result[i].artists + "</th><th class=\"add-button\" onclick = \"addSong(\'" + code + "\',\'" + result[i].uri + "\','" + result[i].name + "\',\'" + result[i].authors + "\')\"><a href=\"#\"><span class=\"glyphicon glyphicon-plus\"></span></a></th></tr>";
                }
